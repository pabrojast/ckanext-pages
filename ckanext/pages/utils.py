...
def pages_edit_modular(page=None, data=None, errors=None, error_summary=None, page_type='pages'):
    """Modular version of pages_edit that uses the new modular template"""
    ...
    if page_type in ['water-news', 'water-events', 'water-publications']:
        ...
        permission_needed = 'ckanext_open_source_software_update'
    ...
    # Use the modular template
    return tk.render(
        'ckanext_pages/%s_edit_modular.html' % page_type, extra_vars=vars)
