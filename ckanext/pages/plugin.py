...
class PagesPlugin(PagesPluginBase):
    ...
    def get_actions(self):
        actions_dict = {
            ...
            # Water Family Public API
            'ckanext_water_family_list': actions.water_family_list,
            'ckanext_water_family_show': actions.water_family_show,
        ...
        if self._data_stories_enabled() and DATA_STORIES_AVAILABLE and ds_actions:
            data_stories_actions = {
                ...
                'data_story_bulk_export': ds_actions.data_story_bulk_export,
                'data_story_bulk_import': ds_actions.data_story_bulk_import,
            }
        ...
        if self._featured_viewers_enabled() and FEATURED_VIEWERS_AVAILABLE and fv_actions:
            featured_viewers_actions = {
                ...
                'featured_viewer_submit': fv_actions.featured_viewer_submit,
                'featured_viewer_review': fv_actions.featured_viewer_review,
                'featured_viewer_approve': fv_actions.featured_viewer_approve,
                'featured_viewer_request_changes': fv_actions.featured_viewer_request_changes,
    ...
    def get_auth_functions(self):
        auth_functions = {
            ...
            'ckanext_water_family_list': auth.water_family_api_list,
            'ckanext_water_family_show': auth.water_family_api_show,
        ...
        if self._data_stories_enabled() and DATA_STORIES_AVAILABLE and ds_auth:
            data_stories_auth = {
                ...
                'data_story_bulk_export': ds_auth.data_story_bulk_export,
                'data_story_bulk_import': ds_auth.data_story_bulk_import,
            }
        ...
        if self._featured_viewers_enabled() and FEATURED_VIEWERS_AVAILABLE and fv_auth:
            featured_viewers_auth = {
                ...
                'featured_viewer_submit': fv_auth.featured_viewer_submit,
                'featured_viewer_review': fv_auth.featured_viewer_review,
                'featured_viewer_approve': fv_auth.featured_viewer_approve,
                'featured_viewer_request_changes': fv_auth.featured_viewer_request_changes,
