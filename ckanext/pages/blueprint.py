...
pages.add_url_rule("/water-news/<page>/revisions", view_func=water_news_revisions)
pages.add_url_rule("/water-news/<page>/revisions/<revision>", view_func=water_news_revisions_preview)
pages.add_url_rule("/water-news/<page>/revisions/<revision>/restore", view_func=water_news_revision_restore, methods=['GET'])
...
pages.add_url_rule("/water-events/<page>/revisions", view_func=water_events_revisions)
pages.add_url_rule("/water-events/<page>/revisions/<revision>", view_func=water_events_revisions_preview)
pages.add_url_rule("/water-events/<page>/revisions/<revision>/restore", view_func=water_events_revision_restore, methods=['GET'])
...
pages.add_url_rule("/water-publications/<page>/revisions", view_func=water_publications_revisions)
pages.add_url_rule("/water-publications/<page>/revisions/<revision>", view_func=water_publications_revisions_preview)
pages.add_url_rule("/water-publications/<page>/revisions/<revision>/restore", view_func=water_publications_revision_restore, methods=['GET'])
