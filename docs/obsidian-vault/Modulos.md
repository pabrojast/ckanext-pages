...
- los embeds llevan `hideStory=1` (además de `hideWorkbench=1&hideExplorerPanel=1`): en el fork de terriajs suprime la apertura automática del panel nativo de story; builds estándar lo ignoran
